...
<?php error_reporting(0) ;?>
    ...
    <table>
        <form action="22vaja-prijava-PHP-Žunec-Jan.php" method="POST">
    ...
    <?php
    $uime = $_POST["uporabniskoime"];
    $geslo = $_POST["geslo"];  
        if (($_POST['uporabniskoime'] == $uime) && ($_POST['geslo'] == $geslo) && ($_POST['uporabniskoime'] != null) && ($_POST['geslo'] != null)){
